/**
 * LeetCode 刷题代码模板（由于官方总是不更新优先队列库，所以我自己复制了一份用于解决优先队列的问题）
 * 
 * 包含两个类，Heap 和 MyPriorityQueue，用于优先队列
 * 代码复制于 https://github.com/datastructures-js/priority-queue 仓库，API文档也在这里
 */
